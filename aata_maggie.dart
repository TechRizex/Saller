...
class AataMaggie extends StatefulWidget {
  const AataMaggie({Key? key}) : super(key: key);

  @override
  State<AataMaggie> createState() => _AataMaggieState();
}

class _AataMaggieState extends State<AataMaggie> {
  @override
            ...
            Stack(
              children: [
                ...
                Positioned(
                  ...
                  right: 30,
                  child: Image.asset(
                    'assets/Images/aata_maggie.png', // Replace with your image path
                    height: 300,
                    width: 300,
                    fit: BoxFit.contain,
                  ),
